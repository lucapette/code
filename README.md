...
My personal monorepo. A collection of projects, experiments, and tools I've built over the years.
...
| Project             | Stack                                                                           | Description                                 |
|---------------------|---------------------------------------------------------------------------------|---------------------------------------------|
| [passata](/passata) | ![React](https://img.shields.io/badge/-React-61DAFB?logo=react&logoColor=black) | Pomodoro technique app                      |
| [tracker](/tracker) | ![Go](https://img.shields.io/badge/-Go-00ADD8?logo=go&logoColor=white)          | Activity tracking with InfluxDB and Grafana |
...
| Project                         | Stack                                                                                          | Description                                           |
|---------------------------------|------------------------------------------------------------------------------------------------|-------------------------------------------------------|
| [isbn-redirect](/isbn-redirect) | ![TypeScript](https://img.shields.io/badge/-TypeScript-3178C6?logo=typescript&logoColor=white) | Cloudflare Worker to redirect ISBNs to The StoryGraph |
