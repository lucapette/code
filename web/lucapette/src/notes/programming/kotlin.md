...
There's some confusion around logging but I blame Java for it. [Kotlin logging](https://github.com/MicroUtils/kotlin-logging) seems nice.
...
I wrote a [configuration library](https://github.com/typestreamio/typestream/tree/main/libs/konfig). Here's how the API looks like:
...
I also played around with method extensions: [klogger.kt](https://gist.github.com/lucapette/3dd7eca10c47de69864bac844b8d0d04).
...
The name comes from [this](https://elizarov.medium.com/extension-oriented-design-13f4f27deaee) article by Roman Elizarov.
