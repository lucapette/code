...
{% book "40604388", "Walkaway", "walkaway.jpg", "200" %}
...
{% book "61224687", "The Space Between Worlds", "the-space-between-worlds.jpg", "200" %}
...
{% book "23593321", "Station Eleven", "station-eleven.jpg", "200" %}
...
{% book "52238882", "The Glass Hotel", "the-glass-hotel.jpg", "200" %}
...
{% book "18619684", "The Time Traveler's Wife", "the-time-travelers-wife.jpg", "200" %}
...
{% book "50892360", "Black Sun", "black-sun.jpg", "200" %}
...
{% book "26114545", "Too Like the Lightning", "too-like-the-lightning.jpg", "200" %}
...
{% book "57292255", "Prima persona singolare", "prima-persona-singolare.jpg", "200" %}
...
{% book "17333324", "Ancillary Justice", "ancillary-justice.jpg", "200" %}
...
{% book "20706284", "Ancillary Sword", "ancillary-sword.jpg", "200" %}
...
{% book "23533039", "Ancillary Mercy", "ancillary-mercy.jpg", "200" %}
...
{% book "32758901", "All Systems Red", "all-systems-red.jpg", "200" %}
...
{% book "36223860", "Artificial Condition", "artificial-condition.jpg", "200" %}
...
{% book "35519101", "Rogue Protocol", "rogue-protocol.jpg", "200" %}
...
{% book "35519109", "Exit Strategy", "exit-strategy.jpg", "200" %}
...
{% book "18007564", "The Martian", "the-martian.jpg", "200" %}
...
{% book "38190066", "Kindred", "kindred.jpg", "200" %}
...
{% book "59663279", "Termination Shock", "termination-shock.jpg", "200" %}
...
{% book "29751398", "The Power", "the-power.jpg", "200" %}
...
{% book "60930", "Bloodchild and Other Stories", "bloodchild-and-other-stories.jpg", "200" %}
...
{% book "25353286", "Provenance", "provenance.jpg", "200" %}
...
{% book "40668314", "Le sorelle Donguri", "le-sorelle-donguri.jpg", "200" %}
...
{% book "58522291", "Americanah", "americanah.jpg", "200" %}
...
{% book "12884314", "China in Ten Words", "china-in-ten-words.jpg", "200" %}
...
{% book "52692608", "Ten Thousand Light", "ten-thousand-light.jpg", "200" %}
...
{% book "55298625", "The Vanishing Half", "the-vanishing-half.jpg", "200" %}
...
{% book "25786523", "The Long Way to a Small, Angry Planet", "the-long-way-to-a-small-angry-planet.jpg", "200" %}
...
{% book "29475447", "A Closed and Common Orbit", "a-closed-and-common-orbit.jpg", "200" %}
...
{% book "32802595", "Record of a Spaceborn Few", "record-of-a-spaceborn-few.jpg", "200" %}
...
{% book "123639782", "Sea of Tranquility", "sea-of-tranquility.jpg", "200" %}
...
{% book "35451559", "Half of a Yellow Sun", "half-of-a-yellow-sun.jpg", "200" %}
...
{% book "48657666", "To Be Taught, If Fortunate", "to-be-taught-if-fortunate.jpg", "200" %}
...
{% book "61403413", "Africa Is Not a Country", "africa-is-not-a-country.jpg", "200" %}
...
{% book "39710105", "The City & The City", "the-city--the-city.jpg", "200" %}
...
{% book "8045416", "To Kill a Mockingbird", "to-kill-a-mockingbird.jpg", "200" %}
...
{% book "58677491", "The Memory Librarian", "the-memory-librarian.jpg", "200" %}
...
{% book "35018907", "Semiosis", "semiosis.jpg", "200" %}
...
{% book "43263202", "Interference", "interference.jpg", "200" %}
...
{% book "60784471", "The Terraformers", "the-terraformers.jpg", "200" %}
...
{% book "37785879", "Purple Hibiscus", "purple-hibiscus.jpg", "200" %}
...
{% book "41161349", "Parable of the Sower", "parable-of-the-sower.jpg", "200" %}
...
{% book "46159606", "Parable of the Talents", "parable-of-the-talents.jpg", "200" %}
...
{% book "41093489", "This Is How You Lose the Time War", "this-is-how-you-lose-the-time-war.jpg", "200" %}
...
{% book "62873911", "Translation State", "translation-state.jpg", "200" %}
...
{% book "34397251", "The Thing Around Your Neck", "the-thing-around-your-neck.jpg", "200" %}
...
{% book "59357120", "Yellowface", "yellowface.jpg", "200" %}
...
{% book "43726511", "The Shadow King", "the-shadow-king.jpg", "200" %}
...
{% book "59350163", "Tomorrow, and Tomorrow, and Tomorrow", "tomorrow-and-tomorrow-and-tomorrow.jpg", "200" %}
...
{% book "69706993", "How High We Go in the Dark", "how-high-we-go-in-the-dark.jpg", "200" %}
...
{% book "70897", "The Secret History", "the-secret-history.jpg", "200" %}
...
{% book "13055592", "Redshirts", "redshirts.jpg", "200" %}
...
{% book "56817598", "A Bigger Picture", "a-bigger-picture.jpg", "200" %}
...
{% book "34051011", "Pachinko", "pachinko.jpg", "200" %}
...
{% book "21418013", "Lock In", "lock-in.jpg", "200" %}
...
{% book "35018901", "Head On", "head-on.jpg", "200" %}
...
{% book "50736031", "Breasts and Eggs", "breasts-and-eggs.jpg", "200" %}
...
{% book "25499718", "Children of Time", "children-of-time.jpg", "200" %}
...
{% book "41584982", "Dove mi trovo", "dove-mi-trovo.jpg", "200" %}
...
{% book "41085049", "Velocity Weapon", "velocity-weapon.jpg", "200" %}
...
{% book "49088636", "Chaos Vector", "chaos-vector.jpg", "200" %}
...
{% book "55836835", "Catalyst Gate", "catalyst-gate.jpg", "200" %}
...
{% book "59808034", "Beautiful World, Where Are You", "beautiful-world-where-are-you.jpg", "200" %}
...
{% book "59364173", "I'm Glad My Mom Died", "im-glad-my-mom-died.jpg", "200" %}
...
{% book "60243617", "Girl, Woman, Other", "girl-woman-other.jpg", "200" %}
...
{% book "36586697", "Queenie", "queenie.jpg", "200" %}
...
{% book "25694095", "A Brief History of Seven Killings", "a-brief-history-of-seven-killings.jpg", "200" %}
...
{% book "125112285", "People Person", "people-person.jpg", "200" %}
...
{% book "39776179", "Dune", "dune.jpg", "200" %}
...
{% book "24777102", "In altre parole", "in-altre-parole.jpg", "200" %}
...
{% book "62839726", "Racconti romani", "racconti-romani.jpg", "200" %}
...
{% book "50716314", "L'eco della pioggia", "leco-della-pioggia.jpg", "200" %}
...
{% book "60522318", "Lost in Time", "lost-in-time.jpg", "200" %}
...
{% book "39699339", "An American Marriage", "an-american-marriage.jpg", "200" %}
...
{% book "34695800", "A Common", "the-goldfinch.jpg", "200" %}
...
{% book "120806182", "The Internet Con", "the-internet-con.jpg", "200" %}
...
{% book "61885029", "Starter Villain", "starter-villain.jpg", "200" %}
...
{% book "54120408", "Klara and the Sun", "klara-and-the-sun.jpg", "200" %}
...
{% book "57945316", "Babel", "babel.jpg", "200" %}
...
{% book "144405196", "The Worlds I See", "the-worlds-i-see.jpg", "200" %}
