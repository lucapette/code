...
{% book "31933061", "Places in the Darkness", "places-in-the-darkness.jpg", "200" %}
...
{% book "22104226", "Climate Change", "climate-change.jpg", "200" %}
...
{% book "50633763", "The Namesake", "the-namesake.jpg", "200" %}
...
{% book "56587385", "The Searcher", "the-searcher.jpg", "200" %}
...
{% book "163481412", "Scattered All Over the Earth", "scattered-all-over-the-earth.jpg", "200" %}
...
{% book "58032440", "Freedom Is A Constant Struggle", "freedom-is-a-constant-struggle.jpg", "200" %}
...
{% book "50240224", "Interpreter of Maladies", "interpreter-of-maladies.jpg", "200" %}
...
{% book "55879881", "Silver Sparrow", "silver-sparrow.jpg", "200" %}
...
{% book "54429617", "The Middle East Crisis Factory", "the-middle-east-crisis-factory.jpg", "200" %}
...
{% book "100322", "Assata", "assata.jpg", "200" %}
...
{% book "44080495", "Talking to My Daughter", "talking-to-my-daughter.jpg", "200" %}
...
{% book "822730", "The Wretched of the Earth", "the-wretched-of-the-earth.jpg", "200" %}
...
{% book "82120", "The Worldly Philosophers", "the-worldly-philosophers.jpg", "200" %}
...
{% book "53237269", "Orientalism", "orientalism.jpg", "200" %}
...
{% book "61041632", "Il popolo delle scimmie", "il-popolo-delle-scimmie.jpg", "200" %}
...
{% book "122184508", "I Have Some Questions For You", "i-have-some-questions-for-you.jpg", "200" %}
...
{% book "37903542", "Il fascismo eterno", "il-fascismo-eterno.jpg", "200" %}
...
{% book "71880568", "Let This Radicalize You", "let-this-radicalize-you.jpg", "200" %}
...
{% book "58537332", "The Myth of Normal", "the-myth-of-normal.jpg", "200" %}
...
{% book "59780089", "The Nutmeg's Curse", "the-nutmegs-curse.jpg", "200" %}
...
{% book "25016210", "Hotel Arcadia", "hotel-arcadia.jpg", "200" %}
...
{% book "53328332", "Less Is More", "less-is-more.jpg", "200" %}
...
{% book "158043792", "A View from the Stars", "a-view-from-the-stars.jpg", "200" %}
...
{% book "29362082", "The Great Derangement", "the-great-derangement.jpg", "200" %}
...
{% book "60324341", "Brotherless Night", "brotherless-night.jpg", "200" %}
...
{% book "60831918", "Dust Child", "dust-child.jpg", "200" %}
...
{% book "816552", "Shantaram", "shantaram.jpg", "200" %}
...
{% book "25489625", "Between the World and Me", "between-the-world-and-me.jpg", "200" %}
...
{% book "52951822", "The Autobiography of Malcolm X", "the-autobiography-of-malcolm-x.jpg", "200" %}
...
{% book "41059420", "The God of Small Things", "the-god-of-small-things.jpg", "200" %}
...
{% book "58684553", "The Dictator's Handbook", "the-dictators-handbook.jpg", "200" %}
...
{% book "58014666", "The New Age of Empire", "the-new-age-of-empire.jpg", "200" %}
...
{% book "198493846", "Living the Asian Century", "living-the-asian-century.jpg", "200" %}
...
{% book "176442611", "Jumpnauts", "jumpnauts.jpg", "200" %}
...
{% book "18210749", "The Great Convergence", "the-great-convergence.jpg", "200" %}
...
{% book "216594557", "A Woman is a School ", "a-woman-is-a-school.jpg", "200" %}
...
{% book "92625", "The Ones Who Walk Away from Omelas", "the-ones-who-walk-away-from-omelas.jpg", "200" %}
...
{% book "50166591", "The Tech Solution", "the-tech-solution.jpg", "200" %}
...
{% book "61223186", "The Island of Missing Trees", "the-island-of-missing-trees.jpg", "200" %}
...
{% book "205645524", "Memoirs of a Teenage Amnesiac", "memoirs-of-a-teenage-amnesiac.jpg", "200" %}
...
{% book "22136", "Out of Place", "out-of-place.jpg", "200" %}
...
{% book "209731336", "The Hidden Globe", "the-hidden-globe.jpg", "200" %}
...
{% book "61645827", "It's Not That Radical", "its-not-that-radical.jpg", "200" %}
