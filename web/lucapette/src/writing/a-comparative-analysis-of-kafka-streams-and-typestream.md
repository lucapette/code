...
Streams](/writing/getting-started-with-kafka-streams) which,
...
data "pipe"lines... right?](/writing/they-are-called-streaming-data-pipelines-right).
...
my [HTTP endpoints with Kafka Streams Interactive Queries](/writing/http-endpoints-with-kafka-streams-interactive-queries)) so you
